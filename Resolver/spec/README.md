...
- `Resolver/spec/request.schema.json` — request schema reference
- `Resolver/spec/response.schema.json` — response schema reference
- `Resolver/spec/examples/request/` — sample request payloads
- `Resolver/spec/examples/response/` — sample response payloads
...
- The current Python validation logic in `Resolver/gateway/contract.py` is implemented directly in code.
