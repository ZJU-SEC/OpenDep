...
from resolving.containerization.runtime.adapter_runtime import AdapterMetadata, emit_payload, error_response
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ecosystem", required=True, help="resolving ecosystem")
    parser.add_argument(
        "--compose-file",
