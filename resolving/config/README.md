...
- `resolving/config/resolvers.container.yaml` — the primary registry for the current containerized resolver stack
- `resolving/config/resolvers.yaml` — a legacy host-process registry kept for fallback and comparison
